---
title: 'Credorax'
description: 'Configuração e integração do serviço de pagamento Credorax no Paylands'
---

## Métodos de pagamento em Sandbox

| Resultado                  | Cartão                     | Notas                                |
| -------------------------- | -------------------------- | ------------------------------------ |
| 3DS2.x Frictionless        | 4018810000100036 12/34 123 |                                      |
| 3DS2.x Fingerprinting only | 4018810001010010 12/34 123 |                                      |
| 3DS2.x Challenge only      | 4018810000150015 12/34 123 | Código 0101 para OK e 3333 para KO   |
| 3DS2.x Full flow           | 4018810000190011 12/34 123 | Código 0101 para OK e 3333 para KO   |
| Pagamento recusado         | 4548812049400004 12/34 123 |                                      |

### Dynamic descriptor

O campo `dynamic_descriptor` é opcional e, caso seja indicado, deverá cumprir uma série de regras específicas:

* Terá um máximo de 13 caracteres.
* Deve começar pelo nome do comerciante, seguido de um asterisco e a informação desejada pelo comerciante.

## Códigos de erro

Credorax pode devolver até dois códigos de erro diferentes, um da processadora e outro do esquema (VISA, MC...).

### Erros da processadora[​](#erros-da-processadora "Link direto para Erros da processadora")

A estrutura do erro tem a seguinte forma:

```
Código da processadora Mensagem da processadora
```
...
Se a operação foi tentada mas ocorreu um erro, o erro tem a seguinte estrutura:

```
Código da processadora Mensagem da processadora [Código do esquema Mensagem do esquema]
```
...
| 1A     | Strong Customer Authentication required           | SCA necessário (soft-decline)    |
