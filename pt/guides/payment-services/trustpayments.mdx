...
description: 'Configuração e integração do serviço de pagamento Trust Payments no Paylands'
---

Aceita pagamentos com cartões de crédito/débito em pelo menos EUR e GBP e suporta a maioria das operações que oferecemos.

## Métodos de pagamento em Sandbox

| Resultado | Cartão                     |
| --------- | -------------------------- |
| Pagamento OK | 4111111111111111 12/34 123 |
...
```
Código - Mensagem [Código esquema Mensagem esquema]
```
...
| 71000  | Soft Decline                                                                                                                                                | Soft-decline (Requer 3DS)   |
| 88000  | Generic Retry                                                                                                                                               |                             |
