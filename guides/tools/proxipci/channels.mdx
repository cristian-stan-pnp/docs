...
En este caso usted necesita un channel de tipo **PULL + TOKENIZATION** donde el atributo endpoint del channel es el endpoint API del channel manager. Usted puede entonces iniciar su solicitud al endpoint de invocación del channel, entonces el PROXY PCI obtendrá las nuevas reservas del endpoint de la API del channel manager, hará su magia, y responderá con las nuevas reservas.
