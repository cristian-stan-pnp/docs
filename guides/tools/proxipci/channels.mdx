...
## PUSH + TOKENIZACIÓN[​](#push--tokenización "Enlace directo al PUSH + TOKENIZACIÓN")
...
## PULL + TOKENIZACIÓN[​](#pull--tokenización "Enlace directo al PULL + TOKENIZACIÓN")
...
## Ejemplo JSON[​](#ejemplo-json "Enlace directo al Ejemplo JSON")
...
## MAPEO DE CAMPOS[​](#mapeo-de-campos "Enlace directo al MAPEO DE CAMPOS")
...
## EJEMPLO DE CANAL EN FUNCIONAMIENTO[​](#ejemplo-de-canal-en-funcionamiento "Enlace directo al EJEMPLO DE CANAL EN FUNCIONAMIENTO")
...
## Ejemplo de XML[​](#ejemplo-de-xml "Enlace directo al Ejemplo de XML")
...
### Mapeo de campos[​](#mapeo-de-campos-1 "Enlace directo al Mapeo de campos")
