...
| `allow_unavailable`             | `boolean`           | No          | `true`  | Permite continuar con el flujo si la verificación **no ha sido realizada** porque no es soportada por el banco o por el tipo/marca de tarjeta, o porque aún pudiendo ser soportada el banco no la ejecuta.                                                                                                                                                                                                                                 |
