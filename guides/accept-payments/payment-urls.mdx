...
Para activarla debemos acceder al panel de Paylands y dirigirnos al menú lateral Administración > Clientes. Una vez aquí accedemos a los detalles del cliente en el cual deseamos activar esta opción y nos dirigimos a la pestaña preferencias de configuración.
