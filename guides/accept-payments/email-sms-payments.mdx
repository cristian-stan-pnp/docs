...
Se pueden incluir campos personalizados en las plantillas de email y SMS. Para ello, el formato que se debe enviar, ya sea desde formulario del panel o enviándolas mediante API deberá ser:
