...
![Envío de pagos vía email y sms](/images/docs/integration/assets/images/email-sms-campaigns-1-7d37b6bfe9da67f44f49b90ec0367392.png)
...
* **URL en caso de fallo**: URL a la que se redirigirá al cliente en caso de error.
...
| URL\_KO           | String  | No        | URL a la que se redirigirá al cliente en caso de error.                                                                                                                                        |
...
Se puede descargar el certificado de apertura del enlace de pago a través del panel, en el detalle de la operación. Disponible para envíos mediante SMS.
...
Se pueden incluir campos personalizados en las plantillas de email y SMS. Para ello, el formato que se debe enviar, ya sea desde el formulario del panel o enviándolas mediante API deberá ser:
