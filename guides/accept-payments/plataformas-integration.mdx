...
<Warning>
  Este método de integración está **exclusivamente disponible para comercios con certificación PCI DSS**. Si tu plataforma no está certificada, debes utilizar la [integración por redirección](/guides/accept-payments/web-integration) o el [pago por webservice](/guides/accept-payments/webservice-payment).
</Warning>
