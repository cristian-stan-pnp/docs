...
Se admiten dos métodos de pago: Tarjeta y [Bizum](/guides/apm/bizum). Las operaciones de devolución, confirmación, cancelación y recuperación de estado son compatibles con ambos métodos de pago. El resto de operaciones están orientadas solamente a tarjetas.
...
| 9899   | Los datos en Ds\_Merchant\_Data no estaban correctamente firmados                                  |                             |
...
| 9024   | SIS0024    | Error Ds\_Merchant\_ConsumerLanguage tiene más de 3 posiciones                                                                                 |       |
...
| 9099   | SIS0099    | Error genérico. Consulte con Soporte                                                                                                           |       |
...
| 9132   | SIS0132    | La fecha de Confirmación de Autorización no puede superar en más de 7 días a la de Preautorización.                                            |       |
| 9133   | SIS0133    | La fecha de Confirmación de Autenticación no puede superar en más de 45 días a la de Autenticación Previa                                      |       |
...
| 9530   | SIS0530    | La fecha de Anulación no puede superar en más de 7 días a la de Preautorización.                                                               |       |
