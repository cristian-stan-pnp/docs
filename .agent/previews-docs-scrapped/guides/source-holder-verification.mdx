---
title: "Verificación del titular del medio de pago (SHV)"
description: "La  es una funcionalidad que permite  de un medio de pago ( o ), comparando los datos del titular aportados en la operación con la información real asociada al medio de pago."
---
...
## Métodos de verificación[​](#métodos-de-verificación "Enlace directo al Métodos de verificación")
...
## ¿En qué flujos se puede usar?[​](#en-qué-flujos-se-puede-usar "Enlace directo al ¿En qué flujos se puede usar?")
...
## Endpoint específico: verificar titular de un source[​](#endpoint-específico-verificar-titular-de-un-source "Enlace directo al Endpoint específico: verificar titular de un source")

### Ejemplo de petición con NAME[​](#ejemplo-de-petición-con-name "Enlace directo al Ejemplo de petición con NAME")
...
### Ejemplo de petición con IDENTIFICATION\_NUMBER[​](#ejemplo-de-petición-con-identification_number "Enlace directo al Ejemplo de petición con IDENTIFICATION_NUMBER")
...
### Ejemplo de respuesta[​](#ejemplo-de-respuesta "Enlace directo al Ejemplo de respuesta")
...
## Aplicar SHV en almacenamiento de source o en pagos[​](#aplicar-shv-en-almacenamiento-de-source-o-en-pagos "Enlace directo al Aplicar SHV en almacenamiento de source o en pagos")
...
### ¿Qué hace este cuerpo?[​](#qué-hace-este-cuerpo "Enlace directo al ¿Qué hace este cuerpo?")
...
## Ejemplos de uso[​](#ejemplos-de-uso "Enlace directo al Ejemplos de uso")

### Tokenizar tarjeta (almacenamiento)[​](#tokenizar-tarjeta-almacenamiento "Enlace directo al Tokenizar tarjeta (almacenamiento)")
...
### Crear cuenta bancaria (almacenamiento)[​](#crear-cuenta-bancaria-almacenamiento "Enlace directo al Crear cuenta bancaria (almacenamiento)")
...
### Crear orden (flujo de pago)[​](#crear-orden-flujo-de-pago "Enlace directo al Crear orden (flujo de pago)")
...
## Campos de `source_holder_verification`[​](#campos-de-source_holder_verification "Enlace directo al campos-de-source_holder_verification")
...
## Respuesta SHV (formato común)[​](#respuesta-shv-formato-común "Enlace directo al Respuesta SHV (formato común)")
...
### Significado de los campos[​](#significado-de-los-campos "Enlace directo al Significado de los campos")
...
## Estados de `status`[​](#estados-de-status "Enlace directo al estados-de-status")
...
## Resultados de coincidencia `match_result`[​](#resultados-de-coincidencia-match_result "Enlace directo al resultados-de-coincidencia-match_result")
...
## Acciones de política `policy_action`[​](#acciones-de-política-policy_action "Enlace directo al acciones-de-política-policy_action")
...
## Simulación en Sandbox (IBAN)[​](#simulación-en-sandbox-iban "Enlace directo al Simulación en Sandbox (IBAN)")
