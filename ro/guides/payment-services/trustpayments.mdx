...
description: 'Configurarea și integrarea serviciului de plată Trust Payments în Paylands'
---

Acceptă plăți cu carduri de credit/debit în cel puțin EUR și GBP și suportă majoritatea operațiunilor pe care le oferim.

## Metode de plată în Sandbox

| Rezultat  | Card                       |
| --------- | -------------------------- |
| Plată OK  | 4111111111111111 12/34 123 |
...
```
Cod - Mesaj [Cod schemă Mesaj schemă]
```
...
| Cod   | Mesaj                                                                                                                                                       | Note                            |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| 0     | Ok                                                                                                                                                          | Operațiune reușită              |
| 1     | Generic error                                                                                                                                               |                                 |
| 2     | Secure Trading API requires the 'requests' library                                                                                                          |                                 |
| 4     | Send error                                                                                                                                                  |                                 |
| 5     | Receive error                                                                                                                                               |                                 |
| 6     | Invalid credentials provided                                                                                                                                |                                 |
| 7     | An issue occurred whilst trying to connect to Secure Trading servers                                                                                         |                                 |
| 8     | Unexpected error connecting to Secure Trading servers. If the problem persists please contact [support@securetrading.com](mailto:support@securetrading.com) |                                 |
...
| 20005 | Refund requires settled parent or parent that's due to settle today                                                                                          |                                 |
...
| 71000 | Soft Decline                                                                                                                                                | Soft-decline (Necesită 3DS)     |
| 88000 | Generic Retry                                                                                                                                               |                                 |
