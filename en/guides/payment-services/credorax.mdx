...
### Processor errors[​](#processor-errors "Direct link to Processor errors")

The error structure has the following form:

```
Processor code Processor message
```
...
```
Processor code Processor message [Scheme code Scheme message]
```
