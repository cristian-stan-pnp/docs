---
title: 'Credorax'
description: 'Configuration and integration of the Credorax payment service in Paylands'
---
...
| 3DS2.x Challenge only      | 4018810000150015 12/34 123 | Code 0101 for OK and 3333 for KO   |
| 3DS2.x Full flow           | 4018810000190011 12/34 123 | Code 0101 for OK and 3333 for KO   |
| Payment declined           | 4548812049400004 12/34 123 |                                    |

### Dynamic descriptor

The `dynamic_descriptor` field is optional and, if provided, must comply with a set of specific rules:

* It has a maximum of 13 characters.
* It must start with the merchant name, followed by an asterisk and the information desired by the merchant.

## Error codes

Credorax can return up to two different error codes, one from the processor and another from the scheme (VISA, MC...).

### Processor errors[​](#errores-de-la-procesadora "Direct link to Processor errors")
...
If the operation was attempted but an error occurred, the error has the following structure:
...
| 03     | Invalid merchant                                  |                              |
| 04     | Pick up card                                      | Category 1 (VISA)            |
| 05     | Do not honour                                     |                              |
| 06     | Error                                             |                              |
| 07     | Pick up card - special condition                  | Category 1 (VISA)            |
| 08     | Honour with identification                        |                              |
| 10     | Partial amount approved                           |                              |
| 12     | Invalid transaction                               | Category 1 (VISA)            |
| 13     | Invalid amount                                    |                              |
| 14     | Invalid card number                               | Category 1 (VISA)            |
| 15     | No such issuer                                    | Category 1 (VISA)            |
| 19     | Re-enter transaction                              |                              |
| 21     | No action taken                                   |                              |
| 30     | Format error                                      |                              |
| 34     | Implausible card data                             |                              |
| 39     | No credit account                                 |                              |
| 41     | Lost card, pick up                                | Category 1 (VISA)            |
| 42     | No universal account                              |                              |
| 43     | Pick up, stolen card                              | Category 1 (VISA)            |
| 44     | No investment account                             |                              |
| 46     | Closed Account                                    | Category 1 (VISA)            |
| 50     | Do not renew                                      |                              |
...
| 54     | Expired card                                      |                              |
| 55     | Incorrect PIN                                     |                              |
| 57     | Transaction not allowed for cardholder            | Category 1 (VISA)            |
...
| 96     | System malfunction                                | Category 2 (VISA)            |
| 97     | Transaction has been declined by the processor    |                              |
| N7     | CVV2 failure                                      |                              |
| R0     | Stop Payment Order                                | Category 1 (VISA)            |
| R1     | Revocation of Authorisation Order                 | Category 1 (VISA)            |
| R3     | Revocation of all Authorisation Orders            | Category 1 (VISA)            |
| 1A     | Strong Customer Authentication required           | SCA required (soft-decline)  |
