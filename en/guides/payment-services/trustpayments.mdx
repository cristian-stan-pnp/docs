...
description: 'Configuration and integration of the Trust Payments payment service in Paylands'
---

Accepts credit/debit card payments in at least EUR and GBP and supports most of the operations we offer.
...
```
Code - Message [Schema Code Schema Message]
```
...
| 71000 | Soft Decline                                                                                                                                                | Soft-decline (Requires 3DS) |
| 88000 | Generic Retry                                                                                                                                               |                             |
